...
-----
(NB: I marked the 'course' label for QAS and the projects for US)
- response measures should be specific thresholds. Otherwise you can't see how well your design supports that measure. (-2)
